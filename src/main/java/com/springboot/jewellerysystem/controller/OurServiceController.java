...
public class OurServiceController {
	...
	public String save(OurService ourService, @RequestParam("file") MultipartFile file, HttpSession session)
			throws IOException {
		String msg = "inserted";
		...
		if (fileName.length() > 3) {
			...
			if (ourService.getId() == null) {
				ourService.setImage("no-img.png");
			}
		}
