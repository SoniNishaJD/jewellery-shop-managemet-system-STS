  ...
  @Override
     public boolean equals(Object obj) {
        ...
        Pages other = (Pages) obj;
         return   Objects.equals(id, other.id)   &&   Objects.equals(pageType, other.pageType)   &&   Objects.equals(pageTitle, other.pageTitle)   &&   Objects.equals(pageDescription, other.pageDescription)   &&   Objects.equals(pageBanner, other.pageBanner)   &&   Objects.equals(status, other.status)  ;
     }
...
return "Pages [id=" + id + ", pageType=" + pageType + ", pageTitle=" + pageTitle + ", pageDescription=" + pageDescription + ", pageBanner=" + pageBanner + ", status=" + status + "]" ; 
 } 
}
