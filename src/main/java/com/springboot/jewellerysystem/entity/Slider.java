  ...
  @Override
     public boolean equals(Object obj) {
        ...
        Slider other = (Slider) obj;
         return   Objects.equals(id, other.id)   &&   Objects.equals(image, other.image)   &&   Objects.equals(text1, other.text1)   &&   Objects.equals(text2, other.text2)   &&   Objects.equals(text3, other.text3)   &&   Objects.equals(text4, other.text4)   &&   Objects.equals(btnText, other.btnText)   &&   Objects.equals(btnLink, other.btnLink)   &&   Objects.equals(status, other.status)  ;
     }
...
public Slider(String image, String text1, String text2, String text3, String text4, String btnText, String btnLink, Integer status ){
 super();
 this.image = image; 
this.text1 = text1; 
this.text2 = text2; 
